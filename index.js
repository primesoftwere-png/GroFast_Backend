...
const { initializeOrderFlowSocket } = require("./socket/orderFlowSocket.js"); // Legacy order flow socket
const { initializeDeliveryTrackingSocket } = require("./socket/deliveryTrackingSocket.js"); // New production-ready tracking socket
...
// Initialize Socket.IO for legacy order flow
initializeOrderFlowSocket(io);
console.log("✓ Socket.IO Order Flow initialized");

// Initialize New Socket.IO Modular Delivery Tracking namespace
initializeDeliveryTrackingSocket(io);
console.log("✓ Socket.IO Delivery Tracking (Redis/Memory Cache) initialized");
